/**
 * Telegram notification utility for BasePad
...
export async function notifyNewSubmission(
  ...
  const message = `
🎯 <b>NEW SUBMISSION ON BASEPAD</b>

<b>Bounty:</b> ${escapeHtml(bountyTitle)}
<b>Prize:</b> ${prize} ETH
<b>Hunter:</b> <code>${hunterAddress}</code>

<a href="https://basepad.app/bounties/${bountyId}">View Submission →</a>
`;
